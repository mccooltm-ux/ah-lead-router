...
export function Sidebar() {
  ...
  return (
    <aside className="fixed left-0 top-0 z-40 flex h-screen w-64 flex-col border-r border-gray-200 bg-slate-900">
      {/* Logo */}
      <div className="flex h-16 items-center gap-3 border-b border-slate-700 px-6">
        ...
        <div>
          <h1 className="text-sm font-semibold text-white">Analyst Hub</h1>
          <p className="text-xs text-slate-400">Lead Router</p>
        </div>
      </div>
